...
def pcd_to_voxel(path):
    ...
    #VOXELIZATION
    voxel_grid = VoxelGrid(pcd_np, x_y_z = dimensi_voxel)
    voxel_2d =np.array(voxel_grid.vector[:,:,:]) 
    voxel_2d =transform_voxel_data(voxel_2d,dimensi_voxel)
...
DATA_DIR = os.path.join("D:/Disertasi/Oprek/OPREK/", "ModelNetOrientasi_pcd/")



#generate_hdf5(DATA_DIR,"data_voxel_orientasi_weight_16.h5")
X_train, y_train, X_test, y_test= read_hdf5("data_voxel_orientasi_weight_16.h5")
